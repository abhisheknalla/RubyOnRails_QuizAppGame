...
class SubgenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subgenre" do
    assert_difference('Subgenre.count') do
      post subgenres_url, params: { subgenre: { name: @subgenre.name, questions: @subgenre.questions } }
    end
  ...
  test "should update subgenre" do
    patch subgenre_url(@subgenre), params: { subgenre: { name: @subgenre.name, questions: @subgenre.questions } }
