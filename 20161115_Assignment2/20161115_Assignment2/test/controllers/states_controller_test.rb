...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { marks: @state.marks, questionid: @state.questionid, quizname: @state.quizname } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { marks: @state.marks, questionid: @state.questionid, quizname: @state.quizname } }
